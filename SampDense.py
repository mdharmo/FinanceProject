...
class SamplingDense(Layer):
    ...
    def __init__(self, units,
        ...
        super(SamplingDense, self).__init__(**kwargs)
        self.units = units
        self.activation = activations.get(activation)
    ...
    def build(self, input_shape):
        ...
        self.kernel_sigma = self.add_weight(shape=(input_dim,self.units),
    ...
    def get_config(self):
        ...
        base_config = super(SamplingDense, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))
